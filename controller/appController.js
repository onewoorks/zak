...
zakApp.controller('stokProsesTarikController', ['$scope', '$http', 'SweetAlert', function ($scope, $http, SweetAlert) {
    ...
    $scope.simpanStokTarik = () => {
        ...
        for (i = 0; i < $scope.listCawanganStok.length; i++) {
            if ($scope.berat_lepas_tarik[i] > 0 && $scope.berat_lepas_tarik[i] != "") {
                ...
                formData.push(input)
                $scope.berat_lepas_tarik[i] = ""
                $scope.nilai_lepas_tarik[i] = ""
            }
        }
        $http({
            headers: {
...
zakApp.controller('aliranAmbilEmasController', ['$scope', '$http', 'generalController', 'SweetAlert', function ($scope, $http, generalController, SweetAlert) {
    angular.extend($scope, generalController);
...
zakApp.controller('stokEmasAmbilController', ['$scope', '$http', '$location', 'SweetAlert', function ($scope, $http, $location, SweetAlert) {
    $scope.cawangan_detail = false;
    $scope.cawangan_itemize = true;
    $scope.tarik_emas = true;
    $scope.berat_ambilan = {}
